...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/ros/Git/Mercury-2020/src/ros-i2cpwmboard-master)
  set(i2cpwm_board_DEVEL_PREFIX /home/ros/Git/Mercury-2020/devel)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/ros/Git/Mercury-2020/install)
...
if(NOT "/home/ros/Git/Mercury-2020/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/Git/Mercury-2020/src/ros-i2cpwmboard-master/${idir}'.  ${_report}")
    endif()
